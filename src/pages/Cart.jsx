          ...
          <div className="flex flex-col flex-1">
            ...
            <div className={ProductDivStyle}>
              <div className=" product flex pl-5 self-start">
                <img
                  className="product_img w-[7.2rem] h-[80%] rounded-lg shadow-lg hover:scale-[1.1] ease-in duration-300"
            ...
            <div className={ProductDivStyle}>
              <div className=" product flex pl-5 self-start">
                ...
                <div className="disc flex items-start justify-between h-auto flex-col ml-6">
                  ...
                  <p className="flex items-center justify-center">
                    <b className="mr-2">Color:</b>
                    <div className="colorSelect bg-neutral-50 ml-1 w-[20px] h-[20px]"></div>
                  </p>
                  <p>
                    <b className="mr-2">Size:</b>M
                  </p>
            ...
            <div className={ProductDivStyle}>
              <div className=" product flex pl-5 self-start">
                <img
                  className="product_img w-[7rem]"
                  src="https://cdn.shopify.com/s/files/1/0240/7285/products/KushJonesLST-ShirtinBlack09_360x.jpg?v=164271973"
                  alt="product_img"
                />

                <div className="disc flex items-start justify-between h-auto flex-col ml-6">
                  <p>
                    <b className="mr-2">ID:</b>1568777
                  </p>
                  <p>
                    <b className="mr-2">Product:</b>Dazzing Black T-shirt
                  </p>
                  <p className="flex items-center justify-center">
                    <b className="mr-2">Color:</b>
                    <div className="colorSelect bg-black ml-1 w-[20px] h-[20px]"></div>
                  </p>
                  <p>
